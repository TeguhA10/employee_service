...
class UserService
{
    ...
    public function getMe(): ?object
    {
        ...
        try {
            ...
            Log::error('UserService getMe failed: ' . $e->getMessage());
        }
    ...
    {
        if (isset(self::$cachedUsers[$userId])) {
        ...
        try {
            ...
            Log::error("UserService getUserById ($userId) failed: " . $e->getMessage());
        }
